...
export const sendTextMessage = mutation({
	...
	handler: async (ctx, args) => {
		...
		// Placeholder for future @gpt and @dall-e integration
if (args.content.startsWith("@gpt") || args.content.startsWith("@dall-e")) {
    console.warn("OpenAI integration is not yet configured.");
}
